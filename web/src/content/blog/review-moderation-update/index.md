...
Only one rating per user counts toward the score. Usually, the latest approved review is the one that counts. Older reviews can remain visible, but their star rating is disabled.

Pending reviews do not replace the old rating yet. If your new review is rejected, your previous valid rating stays active.
...
We reject spam, doxxing, threats, illegal content, clear AI-generated text, unrelated content, and personal fights that do not help anyone.
