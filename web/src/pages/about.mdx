...
User ratings are trust weighted. A five star review from a long-time contributor should not count the same as a five star review from an account created five minutes ago.
...
Comments can be sorted by date, helpfulness, rating, or trust weight. Newest remains the default so recent reports are easy to find.
