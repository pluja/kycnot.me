...
The only official communication channel is via [XMPP](https://xmpp.org) at:

<pre class="select-all">kycnotme@paranoid.network</pre>

#### About XMPP

XMPP is an open-standard communication protocol. It is decentralized and supports strong encryption via OMEMO.

- [List of open public XMPP instances](https://404.city/-/xmpp/public-servers).
- Recommended Android client: [Conversations](https://conversations.im)
- For other platforms, find a [list of clients here](https://xmpp.org/software/?category=clients).

### Account verification

To verify that your account is linked to one of the listed services, please [contact via XMPP](#contact) and provide supporting evidence that you are part of the team, or the admin of the service. Make sure you also share your username.
