...
export const { dataArray: eventKinds, getFn: getEventKindInfo } = makeHelpersForOptions(
  ...
  [
    ...
    },
    {
      ...
      id: 'ALERT',
      label: 'Alert',
      description: 'A serious problem reported about this service, not yet confirmed as a scored incident.',
      classNames: {
    ...
    },
    {
      id: 'INCIDENT',
      label: 'Incident',
      description: 'A confirmed failure that cost users funds or privacy. Penalises the trust score.',
      classNames: {
        banner: 'bg-red-900/50 text-red-300 hover:bg-red-800/60 focus-visible:bg-red-800/60',
        rail: 'bg-red-800',
